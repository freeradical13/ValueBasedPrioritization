...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Example $B(t_F)$ table and model-based scale functions}
  \label{table:btable}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Example $B(t_F)$ table, model-based scale functions, and manually calculated scale functions}
...
\begin{table}[H]
  ...
  \begin{tabular}{lccccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Example $B(t_F)$ table with all scale functions}
  \label{table:btablewithall}
\end{table}

Calculate the product for each action to produce the final $Z(t_F)$ table, sort by the value descending and choose the top $k$ actions. For example:
