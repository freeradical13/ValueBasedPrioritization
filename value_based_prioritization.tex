...
Use each $M(A(t_F))$ to calculate the predicted value $B(t_F)$ (setting negative values to 0) and any scale functions based on the models (e.g. scaling by the relative prediction derivatives using $S_3$). For example:
...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
      Action1 & 0.74     & 1.0    & 1.0    \\
      Action2 & 78.11    & 1.0    & 0.57   \\
