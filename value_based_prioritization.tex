...
Although there are significant efforts to establish the importance of a meaningful life\cite{martela2016three,baumeister1991meanings,frankl1985man,baumeister2013some,park2013assessing,allan2015meaning} and meaningful work\cite{steger2013experiencing,dik2009calling,oades2017wiley,steger2009if} (or a calling\cite{dik2012make} or purpose\cite{george2013meaning}), and survey perceptions of meaningful work\cite{steger2006meaning}, efforts to provide detailed methods of choosing such meaningful work are largely confined to vague techniques such as evaluations of psychological profiles for signature strengths\cite{seligman2006learned}, career counseling\cite{dik2009calling} or therapy\cite{wong2010meaning}, and job search training\cite{zikic2009job}. These approaches are important prerequisites but their less quantitative and less explicit nature make them difficult to evaluate, generalize, and improve.
...
\enquote{Why a Goal?} is usually best scoped using value systems because they are evaluative by nature\cite{value-theory}.
Comparing value systems is left as an (lifelong) exercise for the reader\footnote{Example value systems include intuitionism\cite{huemer2007ethical}, consequentialism\cite{consequentialism}, evolutionary biology\cite{morality-biology}, religion\cite{religion-morality}, epicureanism\cite{epicurus}, stoicism\cite{stoicism}, political liberalism\cite{rawls}, anarcho-capitalism\cite{huemer2013problem}, communitarianism\cite{communitarianism}, objectivism\cite{ayn-rand}, etc.}.
