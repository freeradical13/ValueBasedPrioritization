...
\begin{figure}[H]
  ...
  \caption{Highest priority action from the 113 Selected Causes of Death list for the United States: \textit{TODO}}\label{fig:exampleresult1}
\end{figure}
...
\begin{enumerate}
  ...
  \item Minimally grouped causes of death for the United States\cite{centers2017underlying}\textsuperscript{,}\footnote{Group Results By \enquote{Year} And By \enquote{Cause of death}; Check \enquote{Export Results}; Uncheck \enquote{Show Totals}}:
\end{enumerate}
