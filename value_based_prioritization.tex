...
Run each comparable prediction model $R_i(D(A))$. For example, for \textit{Ischemic heart diseases}\footnote{\texttt{python3 -m vbp.run predict UnderlyingCausesOfDeathUnitedStates --ets-no-multiplicative-models --do-not-obfuscate -p 10 "Ischemic heart diseases"}}, see Figure \ref{fig:neoplasmregs}:
