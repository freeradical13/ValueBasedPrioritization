...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{results/UCOD_1999_2017_ICD10_113_CAUSES_LEAVES/RawName108_ets.png}
  \caption{Exponential smoothing functions $ETS(A,*,N),\phi=0.98$ using Holt's linear trend method for \textit{TODO}}\label{fig:exampleresult1}
\end{figure}

The same analysis is run on other groupings of causes of death:

\begin{enumerate}
  \item ICD-10 113 Cause List including subtotals\cite{centers2017underlying}\textsuperscript{,}\footnote{Group Results By \enquote{Year} And By \enquote{ICD-10 113 Cause List}; Check \enquote{Export Results}; Uncheck \enquote{Show Totals}}:
  \item Longterm comparable leading causes of death\cite{uslcod19001998,nbermortality,centers2017underlying,uspopulation19002001,censusestimates19001999}:
  \item ICD-10 20 Chapters\cite{centers2017underlying}\textsuperscript{,}\footnote{Group Results By \enquote{Year} And By \enquote{ICD Chapter}; Check \enquote{Export Results}; Uncheck \enquote{Show Totals}}:
  \item ICD-10 179 Sub-Chapters\cite{centers2017underlying}\textsuperscript{,}\footnote{Group Results By \enquote{Year} And By \enquote{ICD Sub-Chapter}; Check \enquote{Export Results}; Uncheck \enquote{Show Totals}}:
  \item Ungrouped causes of death\cite{centers2017underlying}\textsuperscript{,}\footnote{Group Results By \enquote{Year} And By \enquote{Cause of death}; Check \enquote{Export Results}; Uncheck \enquote{Show Totals}}:
\end{enumerate}
