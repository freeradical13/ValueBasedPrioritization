...
\begin{enumerate}
  ...
  \item Minimally grouped (11,316) causes of death for the World\cite{whomortality}\textsuperscript{,}\footnote{Without $S_3$ because comprehensive granular age data doesn't exist, and without $S_4$ due to the sheer number of causes.}:
    \begin{table}[H]
      ...
      \begin{tabular}{clc}
        \toprule
          $k$ & Action                  & $Z(t_F)$ \\
        \midrule
          1   & Eliminate: RawName07928 & 0.19     \\
          2   & Eliminate: RawName02631 & 0.14     \\
        \bottomrule
      \end{tabular}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.5\textwidth]{results/World/RawName07928_ets.png}
      \caption{Highest priority action from the Minimally grouped (11,316) causes of death for the World: \textit{RawName07928}}\label{fig:k7}
    \end{figure}
\end{enumerate}
